    ...
    return (
        <CardHeader flex justify='center' align='center' height={{ max: '50px' }}>
            <Box direction='row' width='20%'>
                <Button color='black' icon={<LinkPrevious color='black' rotate='180deg' />} size='small' onClick={onExit} />
            </Box>
            <Box direction='row' justify='center' align='center' width='80%' gap='10px'>
